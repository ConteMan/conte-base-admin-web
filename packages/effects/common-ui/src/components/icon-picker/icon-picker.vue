...
<template>
  ...
  >
    ...
    <div class="flex h-[460px] flex-col overflow-hidden">
    <div class="flex w-full shrink-0 px-2 pb-2 pt-1">
      <component
        v-if="inputComponent"
        :is="inputComponent"
    ...
    <template v-if="paginationList.length > 0">
      <div class="grid min-h-0 flex-1 grid-cols-6 justify-items-center overflow-y-auto px-2 pb-2">
        <VbenIconButton
      ...
      <div
        v-if="total >= pageSize"
        class="flex-center flex shrink-0 justify-end border-t px-3 py-2"
      >
        <Pagination
